...
public abstract class MicroservicesWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static MicroservicesWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(MicroservicesWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<MicroservicesDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<MicroservicesDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<MicroservicesDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<MicroservicesDbContext, Task<T>> func)
    {
        T result;
