...
namespace datntdev.Microservices.EntityFrameworkCore.Seed.Host;
...
public class DefaultLanguagesCreator
{
    ...
    {
        var tenantId = MicroservicesConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
